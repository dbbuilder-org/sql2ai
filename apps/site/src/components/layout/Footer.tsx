...
const footerLinks = {
  ...
  resources: [
    ...
    { name: 'Status', href: 'https://status.sql2.ai' },
  ],
  company: [
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold text-text-primary">SQL2.AI</span>
            </Link>
            <p className="mt-4 text-small text-text-muted">
              AI-powered database development for SQL Server and PostgreSQL.
            </p>
            <div className="mt-6 flex gap-4">
              <a
                href="https://github.com/sql2ai"
                target="_blank"
