@echo off
REM SQLReleaseNotes2 - Metadata Generator
setlocal enabledelayedexpansion
color 0A

echo ===============================================================================
echo                       METADATA GENERATOR
echo ===============================================================================
echo.
...
REM Run metadata module
echo.
echo Running metadata module...
echo Command: python ..\sqlreleasenotes.py metadata --new-db %NEW_DB% --old-db %OLD_DB% %PREVIEW_FLAG%
echo.
python ..\sqlreleasenotes.py metadata --new-db %NEW_DB% --old-db %OLD_DB% %PREVIEW_FLAG%
if !errorlevel! neq 0 (
...
echo.
echo Check the output\metadata directory for the generated files.
echo.
pause
